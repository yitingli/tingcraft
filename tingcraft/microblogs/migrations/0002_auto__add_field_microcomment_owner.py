...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MicroComment.owner'
        db.add_column(u'microblogs_microcomment', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.TingUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MicroComment.owner'
        db.delete_column(u'microblogs_microcomment', 'owner_id')
