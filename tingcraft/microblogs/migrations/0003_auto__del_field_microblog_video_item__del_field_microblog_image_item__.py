...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MicroBlog.video_item'
        db.delete_column(u'microblogs_microblog', 'video_item_id')

        # Deleting field 'MicroBlog.image_item'
        db.delete_column(u'microblogs_microblog', 'image_item_id')

        # Adding field 'MicroBlog.media_frame'
        db.add_column(u'microblogs_microblog', 'media_frame',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediaframes.MediaFrame'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'MicroBlog.video_item'
        db.add_column(u'microblogs_microblog', 'video_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediabox.MediaVideo'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MicroBlog.image_item'
        db.add_column(u'microblogs_microblog', 'image_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mediabox.MediaImage'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'MicroBlog.media_frame'
        db.delete_column(u'microblogs_microblog', 'media_frame_id')
    ...
    models = {
        ...
        u'microblogs.microblog': {
            'Meta': {'object_name': 'MicroBlog'},
            'content': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '180', 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_frame': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mediaframes.MediaFrame']", 'null': 'True', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TingUser']"})
        },
        u'microblogs.microcomment': {
            'Meta': {'object_name': 'MicroComment'},
            'content': ('django.db.models.fields.CharField', [], {'max_length': '180'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'micro_blog': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['microblogs.MicroBlog']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TingUser']"}),
            'parent_comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['microblogs.MicroComment']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
        u'users.tinguser': {
