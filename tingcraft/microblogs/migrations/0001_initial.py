...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'microblogs_microblog', (
            ...
            ('content', self.gf('django.db.models.fields.CharField')(default='', max_length=180, blank=True)),
        ...
        db.send_create_signal(u'microblogs', ['MicroBlog'])

        # Adding model 'MicroComment'
        db.create_table(u'microblogs_microcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('micro_blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microblogs.MicroBlog'])),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=180)),
            ('parent_comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microblogs.MicroComment'], null=True, on_delete=models.SET_NULL, blank=True)),
        ))
        db.send_create_signal(u'microblogs', ['MicroComment'])


    def backwards(self, orm):
        # Deleting model 'MicroBlog'
        db.delete_table(u'microblogs_microblog')

        # Deleting model 'MicroComment'
        db.delete_table(u'microblogs_microcomment')
