...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'blogs_blog', 'title',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'blogs_blog', 'title')
    ...
    models = {
        ...
        u'blogs.blog': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'db_index': 'True'})
        },
        u'blogs.comment': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TingUser']"}),
            'parent_comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blogs.Comment']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
