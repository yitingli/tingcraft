...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpDevision.description'
        db.add_column(u'experience_expdevision', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'ExpDevision.rank'
        db.alter_column(u'experience_expdevision', 'rank', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):
        # Deleting field 'ExpDevision.description'
        db.delete_column(u'experience_expdevision', 'description')


        # Changing field 'ExpDevision.rank'
        db.alter_column(u'experience_expdevision', 'rank', self.gf('django.db.models.fields.IntegerField')())
