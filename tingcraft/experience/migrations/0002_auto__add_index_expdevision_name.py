...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ExpDevision', fields ['name']
        db.create_index(u'experience_expdevision', ['name'])


    def backwards(self, orm):
        # Removing index on 'ExpDevision', fields ['name']
        db.delete_index(u'experience_expdevision', ['name'])
