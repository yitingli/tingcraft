...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoteBoard.slug'
        db.add_column(u'noteboards_noteboard', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='default', max_length=50),
                      keep_default=False)

        # Adding unique constraint on 'NoteBoard', fields ['owner', 'slug']
        db.create_unique(u'noteboards_noteboard', ['owner_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'NoteBoard', fields ['owner', 'slug']
        db.delete_unique(u'noteboards_noteboard', ['owner_id', 'slug'])

        # Deleting field 'NoteBoard.slug'
        db.delete_column(u'noteboards_noteboard', 'slug')
