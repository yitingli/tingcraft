...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoteBoard.is_public'
        db.add_column(u'noteboards_noteboard', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoteBoard.is_public'
        db.delete_column(u'noteboards_noteboard', 'is_public')
    ...
    models = {
        ...
        u'noteboards.noteboard': {
            'Meta': {'unique_together': "(('owner', 'slug'),)", 'object_name': 'NoteBoard'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
